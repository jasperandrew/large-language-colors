...
def print_summary(all_results, pair_types, unweighted):
    print(f"\n=== {'Unweighted' if unweighted else 'Weighted'} Average Across Languages ===\n")
    header = f"{'Pair':<20} {'JSD':>8} {'JSD 95% CI':>16} {'Spearman ρ':>11} {'Spearman 95% CI':>18}"
    print(header)
    print("-" * len(header))
...
def main():
    ...
    print_summary(all_results, pair_types, args.unweighted)
